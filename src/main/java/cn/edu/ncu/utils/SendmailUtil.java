...
public class SendmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "1246650576@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "riwjnnhcmhpbfffi";
    ...
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
        ...
        //写入我的官网
        builder.append("\n官网：" +   "http://localhost:8080/ssm/index.html");
        ...
        msg.setFrom(new InternetAddress(myEmailAccount,"最家家居", "UTF-8"));
