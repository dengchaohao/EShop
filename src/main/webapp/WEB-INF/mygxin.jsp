        ...
        <div class="you fl">
            <div class="tx clearfix">
                <div class="fl clearfix">
                    <a href="mygxin.html"><img style="width:92px; height:92px; border-radius:50%;" src="${user.headPic}"/></a>
                    <p class="fl"><span>${user.name}</span><a href="mygrxx.html">修改个人信息></a></p>
                </div>
            ...
            <div class="bott">
                <div class="clearfix">
                    ...
                    <p class="fl"><span>待支付的订单：<strong>${toBePaid}</strong></span>
                        <a href="myorderq.html?pageNumber=1">查看待支付订单></a>
                    </p>
                </div>
                <div class="clearfix">
                    <a href="#" class="fl"><img src="img/gxin2.jpg"/></a>
                    <p class="fl"><span>待收货的订单：<strong>${toBeReceived}</strong></span>
                        <a href="myorderq.html?pageNumber=1">查看待收货订单></a>
                    </p>
                </div>
                <div class="clearfix">
                    <a href="#" class="fl"><img src="img/gxin3.jpg"/></a>
                    <p class="fl"><span>待评价的订单：<strong>${toBeEvaluated}</strong></span>
