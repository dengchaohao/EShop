    ...
    <div class="wrapper clearfix">
        ...
        <div class="you fl">
            ...
            <div class="sx clearfix">
                <div class="clearfix">
                    <c:forEach items="${toBeEvaluated}" var="goodsItem" >
                        <dl class="fl">
                            <input class="orderItemId" type="hidden" name="orderItemId" value="${goodsItem.orderDetailId}"/>
                            <dt><a href="#"><img src="${goodsItem.picPath}"/></a></dt>
                            <dd><a href="#">${goodsItem.title}</a></dd>
                            <dd>¥${goodsItem.price}</dd>
                            <dd>16000人评价</dd>
                            <dd><a href="#2">评价</a></dd>
                        </dl>
                    </c:forEach>
                ...
                <div class="clearfix">
                    <c:forEach items="${evaluated}" var="goodsItem" >
                        <dl class="fl">
                            <input class="orderItemId" type="hidden" name="orderItemId" value="${goodsItem.orderDetailId}"/>
                            <input class="content" type="hidden" name="content" value="${goodsItem.content}"/>
                            <dt><a href="#"><img src="${goodsItem.picPath}"/></a></dt>
                            <dd><a href="#">${goodsItem.title}</a></dd>
                            <dd>¥${goodsItem.price}</dd>
                            <dd>16000人评价</dd>
                ...
                <div class="clearfix">
                    <c:forEach items="${evaluationFailure}" var="goodsItem" >
                        <dl class="fl">
                            <dt><a href="#"><img src="${goodsItem.picPath}"/></a></dt>
                            <dd><a href="#">${goodsItem.title}</a></dd>
                            <dd>¥${goodsItem.price}</dd>
...
<div class="pj">
    ...
    <h3>商品评分</h3>
    <form action="comment" class="form" method="get">
        <div class="clearfix">
            <p class="fl">请打分：</p>
            <p class="fl" id="xin">
        ...
        <input class="orderItemId" type="hidden" name="orderItemId" value=""/>
        <div class="bc">
...
<div class="chak">
    <div class="clearfix"><a href="#" class="fr gb"><img src="img/icon4.png"/></a></div>
    <h3>商品评分</h3>
    <form action="updateComment" class="form" method="get">
        <div class="clearfix">
            <p class="fl">请打分：</p>
            <p class="fl" id="xin">
        ...
        <textarea name="content" rows="" cols="" placeholder="请输入评价">挺好的挺好的挺好的~五分好评</textarea>
        <input class="orderItemId" type="hidden" name="orderItemId" value=""/>
        <div class="bc">
