...
<div class="paintCon">
    <section class="wrapper">
        ...
        <div class="paintList">
            <c:forEach items="${simpleAndModern}" var="good">
                    <a href="proDetail.html?goodsId=${good.goodsId}">
                        <dl>
                            <dt><img src="${good.prodetPic}"></dt>
                            <dd>${good.name}</dd>
                            <dd>￥${good.price}</dd>
                        </dl>
                    </a>
    ...
    <section class="wrapper">
        ...
        <div class="paintList">
            <c:forEach items="${passionateFeeling}" var="good">
                <a href="proDetail.html?goodsId=${good.goodsId}">
                    <dl>
                        <dt><img src="${good.prodetPic}"></dt>
                        <dd>${good.name}</dd>
    ...
    <section class="wrapper">
        ...
        <div class="paintList third">
            ...
            <div class="sec">
                <c:forEach items="${romanticOne}" var="good">
                    <a href="proDetail.html?goodsId=${good.goodsId}">
                        <dl>
                            <dt><img src="${good.prodetPic}"></dt>
                            <dd>${good.name}</dd>
    ...
    <section class="wrapper">
        ...
        <div class="paintList last">
            ...
            <div class="sec">
                <c:forEach items="${romanticTwo}" var="good">
                    <a href="proDetail.html?goodsId=${good.goodsId}">
                        <dl>
                            <dt><img src="${good.prodetPic}"></dt>
                            <dd>${good.name}</dd>
