...
<div class="news">
    <div class="wrapper">
        ...
        <div class="top clearfix">
            <a href="proDetail.html?goodsId=149187842867912"><img src="img/n1.jpg"/>
                <p></p></a>
            <a href="proDetail.html?goodsId=149187842867912"><img src="img/n2.jpg"/>
                <p></p></a>
            <a href="proDetail.html?goodsId=149187842867912"><img src="img/n3.jpg"/>
                <p></p></a>
        </div>
        <div class="bott clearfix">
            <a href="proDetail.html?goodsId=149187842867912"><img src="img/n4.jpg"/>
                <p></p></a>
            <a href="proDetail.html?goodsId=149187842867912"><img src="img/n5.jpg"/>
                <p></p></a>
            <a href="proDetail.html?goodsId=149187842867912"><img src="img/n6.jpg"/>
                <p></p></a>
        </div>
        ...
        <c:forEach items="${list1}" var="goods">
            <div class="flower clearfix tran">
                    <c:forEach items="${goods}" var="good">
                        <a href="proDetail.html?goodsId=${good.goodsId}">
                            <dl>
                                <dt>
                                    <span class="abl"></span>
                                    <img src="${good.prodetPic}"/>
                                    <span class="abr"></span>
                                </dt>
                                <dd>${good.name}</dd>
