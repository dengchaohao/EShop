...
<div class="cart mt">
    ...
    <div class="table wrapper">
        ...
        <%--@elvariable id="cart" type="cn.edu.ncu.pojo.Cart"--%>
        <c:forEach items="${cart.goods}" var="entry">
            <div class="th">
                <div class="pro clearfix">
                    <label class="fl">
                        <input type="checkbox" value="${entry.key.key.goodsId},${entry.key.value},${entry.value.key},${entry.value.value}" name="box"/>
                        <span></span>
                    </label>
                    <a class="fl" href="#">
                        <dl class="clearfix">
                            <dt class="fl"><img src="${entry.value.value}"></dt>
                            <dd class="fl">
                ...
                <div class="price">￥${entry.key.key.price}</div>
                <div class="number">
                    <p class="num clearfix">
                        <img class="fl sub" src="img/temp/sub.jpg">
                        <span class="fl">${entry.value.key}</span>
                        <img class="fl add" src="img/temp/add.jpg">
                    </p>
                </div>
                <div class="price sAll">￥20.00</div>
                <div class="price"><a class="del" href="#">删除</a></div>
            </div>
            <div class="mask"></div>
            <div class="tipDel">
                <p>确定要删除该商品吗？</p>
                <p class="clearfix">
                    <a class="fl cer" href="removeGoodsFromCart?id=${entry.key.key.goodsId}&spec=${entry.key.value}">确定</a>
        ...
        <div class="tr clearfix">
            ...
            <p class="fl">
                <a href="#">全选</a>
                <a href="#" onclick="myjs1()" class="del">删除</a>
            </p>
            <p class="fr">
                <span>共<small id="sl">0</small>件商品</span>
                <span>合计:&nbsp;<small id="all">￥0.00</small></span>
                <a href="#" onclick="myjs()" class="count">结算</a>
            </p>
        </div>
    </div>
</div>
...
<script type="text/javascript" >
    function myjs(){
        allcheck = document.getElementsByName("box");
        if (allcheck != null){
            check_val = []
            for(k in allcheck ){
                if(allcheck[k].checked){
                    check_val.push(allcheck[k].value)
                }
            }
            $.ajax({
                url:'settleAccounts',
