...
<div class="Bott">
    <div class="wrapper clearfix">
        ...
        <div class="you fl">
            <h2>个人信息</h2>
            <div class="gxin">
                <div class="tx"><a href="#"><img style="width: 92px; height: 92px;border-radius:50%;" src="${user.headPic}"/>
                    <p id="avatar">修改头像</p></a></div>
                <div class="xx">
                    <h3 class="clearfix"><strong class="fl">基础资料</strong><a href="#" class="fr" id="edit1">编辑</a></h3>
                    <div>姓名：${user.name}</div>
                    <div>生日：
                        <fmt:formatDate value="${user.birthday}" dateStyle="medium"/>
                    </div>
...
<div class="bj">
    ...
    <form action="modifyUser" method="get">
        ...
        <p><label>生日：</label><input name="birthday" value="<fmt:formatDate value='${user.birthday}' pattern='yyyy-MM-dd'/>"
                                    type="text" dateFmt="yyyy-MM-dd"/></p>
        <p>
            <label>性别：</label>
            <span><input type="radio" checked="checked" name="gender" value="1"/>男</span>
...
<div class="avatar">
    ...
    <form action="upload" method="post" enctype="multipart/form-data">
        <h4>请上传图片</h4>
        <input type="file" name="file" style="font-size: 100%;font-family: inherit;margin: 0;padding: 0;border: none;outline: none; display: block;width: 200px;height: 40px;line-height: 40px; margin: 0 auto;background: #A10000;color: #FFFFFF;" value="上传头像"/>
        <p>jpg或png，大小不超过2M</p>
